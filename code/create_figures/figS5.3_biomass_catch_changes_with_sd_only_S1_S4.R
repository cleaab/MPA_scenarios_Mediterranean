...
plot.biomass.catch.change.Med.with.sd = function(Biom_GSA_prop, Biom_GSA_uniform, Biom_fline, Catch_GSA_prop, Catch_GSA_uniform, Catch_fline, save = TRUE){
  ...
  biom_change_GSAprop <- ggplot() +
    ...
    #geom_ribbon(data = Biom_random_scenarios_GSAprop, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Biom_EEZ_scenarios_GSAprop, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Biom_EEZ_scenarios_GSAprop, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    
    geom_line(data = Biom_lit_scenarios_GSAprop, aes(x = mpa.coverage, y = rel_biom_change_mean, colour = scenario), lwd = 0.8, alpha=1) +
    geom_ribbon(data = Biom_lit_scenarios_GSAprop, aes(x = mpa.coverage, ymin = rel_biom_change_mean - rel_biom_change_sd, ymax = rel_biom_change_mean + rel_biom_change_sd, fill = scenario), alpha = 0.1) +
  ...
  biom_change_GSAuniform <- ggplot() +
    ...
    #geom_ribbon(data = Biom_random_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Biom_EEZ_scenarios_GSAuniform, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1, linetype = "solid") +
    #geom_ribbon(data = Biom_EEZ_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    ...
    geom_ribbon(data = Biom_lit_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = rel_biom_change_mean - rel_biom_change_sd, ymax = rel_biom_change_mean + rel_biom_change_sd, fill = scenario), alpha = 0.1) +
  ...
  biom_change_fline <- ggplot() +
    ...
    #geom_ribbon(data = Biom_random_scenarios_fline, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Biom_EEZ_scenarios_fline, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1, linetype = "solid") +
    #geom_ribbon(data = Biom_EEZ_scenarios_fline, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    ...
    geom_ribbon(data = Biom_lit_scenarios_fline, aes(x = mpa.coverage, ymin = rel_biom_change_mean - rel_biom_change_sd, ymax = rel_biom_change_mean + rel_biom_change_sd, fill = scenario), alpha = 0.1) +
  ...
  catch_change_GSAprop <- ggplot() +
    ...
    #geom_ribbon(data = Catch_random_scenarios_GSAprop, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Catch_EEZ_scenarios_GSAprop, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Catch_EEZ_scenarios_GSAprop, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    
    geom_line(data = Catch_lit_scenarios_GSAprop, aes(x = mpa.coverage, y = rel_catch_change_mean, colour = scenario), lwd = 0.8, alpha=1) +
    geom_ribbon(data = Catch_lit_scenarios_GSAprop, aes(x = mpa.coverage, ymin = rel_catch_change_mean - rel_catch_change_sd, ymax = rel_catch_change_mean + rel_catch_change_sd, fill = scenario), alpha = 0.1) +
  ...
  catch_change_GSAuniform <- ggplot() +
    ...
    #geom_line(data = Catch_random_scenarios_GSAuniform, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Catch_random_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Catch_EEZ_scenarios_GSAuniform, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Catch_EEZ_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    
    geom_line(data = Catch_lit_scenarios_GSAuniform, aes(x = mpa.coverage, y = rel_catch_change_mean, colour = scenario), lwd = 0.8, alpha=1) +
    geom_ribbon(data = Catch_lit_scenarios_GSAuniform, aes(x = mpa.coverage, ymin = rel_catch_change_mean - rel_catch_change_sd, ymax = rel_catch_change_mean + rel_catch_change_sd, fill = scenario), alpha = 0.1) +
  ...
  catch_change_fline <- ggplot() +
    ...
    #geom_line(data = Catch_random_scenarios_fline, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Catch_random_scenarios_fline, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.3) +
    
    #geom_line(data = Catch_EEZ_scenarios_fline, aes(x = mpa.coverage, y = mean, colour = scenario), lwd = 0.8, alpha=1) +
    #geom_ribbon(data = Catch_EEZ_scenarios_fline, aes(x = mpa.coverage, ymin = mean - sd, ymax = mean + sd, fill = scenario_group), alpha = 0.2) +
    
    geom_line(data = Catch_lit_scenarios_fline, aes(x = mpa.coverage, y = rel_catch_change_mean, colour = scenario), lwd = 0.8, alpha=1) +
    geom_ribbon(data = Catch_lit_scenarios_fline, aes(x = mpa.coverage, ymin = rel_catch_change_mean - rel_catch_change_sd, ymax = rel_catch_change_mean + rel_catch_change_sd, fill = scenario), alpha = 0.1) +
  ...
  fig1_body <- plot_grid(fig1A, fig1B,
                         ncol = 1, nrow = 2,
  ...
  if (save == TRUE){
    ggsave(here("figures/Fig_1_total_biomass_catch_ed_with_variability_S1_S4.png"), dpi = 1000, height = 10, width = 10)

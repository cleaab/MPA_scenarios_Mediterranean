...
plot.fig.supplementary.S6.other.scenarios.S1.S4.S5.S6.with.sd <- function(biomass_by_groups_data, catch_by_groups_data, scen, save = TRUE){
...
plot.fig.supplementary.S6.other.scenarios.S2.with.sd <- function(biomass_by_groups_data, catch_by_groups_data, save = TRUE){
...
plot.fig.supplementary.S6.other.scenarios.S3.with.sd <- function(biomass_by_groups_data, catch_by_groups_data, save = TRUE){
